...
CREATE OR REPLACE VIEW vw_clientes_cuentas_radicacion AS
...
CREATE OR REPLACE VIEW vw_datos_empleados AS
...
CREATE OR REPLACE VIEW vw_detalle_operaciones AS
...
CREATE OR REPLACE VIEW vw_operaciones_aprobadas AS
 	(SELECT t.id_transaccion, t.id_cliente, t.fecha, o.tipo_operacion, t.monto, e.estado_operacion 
	FROM transacciones AS t
	INNER JOIN operaciones AS o ON t.tipo_transaccion = o.id_operacion
	INNER JOIN estado AS e ON t.estado = e.id_estado
...
CREATE OR REPLACE VIEW vw_operaciones_en_proceso AS
 	(SELECT t.id_transaccion, t.id_cliente, t.fecha, o.tipo_operacion, t.monto, e.estado_operacion 
	FROM transacciones AS t
	INNER JOIN operaciones AS o ON t.tipo_transaccion = o.id_operacion
	INNER JOIN estado AS e ON t.estado = e.id_estado
...
CREATE OR REPLACE VIEW vw_operaciones_rechazada AS
 	(SELECT t.id_transaccion, t.id_cliente, t.fecha, o.tipo_operacion, t.monto, e.estado_operacion 
	FROM transacciones AS t
	INNER JOIN operaciones AS o ON t.tipo_transaccion = o.id_operacion
	INNER JOIN estado AS e ON t.estado = e.id_estado
